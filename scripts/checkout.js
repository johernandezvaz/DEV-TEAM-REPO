document.addEventListener("DOMContentLoaded", async function() {
  try {
      ...
      async function initialize(ticketType) {
          try {
              ...
              alert("Error initializing payment elements.");
          }
      }
      ...
      async function handleSubmit(e) {
          ...
          if (nombre && apellido && correo && telefono && asistira && ticketType) {
              ...
              document.getElementById("pago-section").classList.add("slide-in");

              await initialize(ticketType);
          } else {
      ...
      alert("Error fetching configuration. Please check the server and try again.");
  }
});
