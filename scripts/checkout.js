document.addEventListener("DOMContentLoaded", async function () {
  try {
    ...
    async function handleSubmit(e) {
      ...
      const asistira = document.querySelector(
    ...
    async function handleSuccessfulPayment(config) {
        ...
        .insert([
          {
            ...
            email: correo,
            telefono,
            asistencia_rompehielos: asistira,
          },
        ])
        .select("id")
        .single();
      ...
      try {
        ...
        const logoUrl = "../assets/logos.webp";
        ...
        page.drawText(`Correo: ${correo}`, {
          x: 20,
          y: page.getHeight() - logoDims.height - 140,
          size: 30,
        });
        page.drawText(`Teléfono: ${telefono}`, {
          x: 20,
          y: page.getHeight() - logoDims.height - 180,
          size: 30,
        });
        page.drawText(`Evento Rompe Hielos: ${asistira}`, {
          x: 20,
