      ...
      try {
          ...
          async function handleSuccessfulPayment(config) {
              ...
              try {
                  ...
                  page.drawText(`Asistira al Evento Rompe Hielos: ${asistenciaRompehielos}`, {
                      x: 20,
          ...
          async function verificarLimite() {
              ...
              if (error) {
                  showModalPopup("Error al verificar el límite de registros.");
                  return false;
              }

              if (count >= 600) {
                  showModalPopup("El límite de 600 registros ha sido alcanzado. No se pueden ingresar más datos.");
                  return false;
              }
