...
document.addEventListener("DOMContentLoaded", async () => {
    try {
        const configResponse = await fetch("https://codec-96h3.onrender.com/config");
...
async function initializePayment(config) {
    try {
        ...
        const response = await fetch("https://codec-96h3.onrender.com/create-payment-intent", {
            method: "POST",
...
async function verifyEmailUniqueness() {
    ...
    const response = await fetch(`https://codec-96h3.onrender.com/check-email?email=${correo}`);
